...
This script has been superseded by the `librarian assign-sessions` command.
...
if __name__ == "__main__":
    warnings.warn("This script has been supserseded by the `librarian assign-sessions` "
    ...
    sys.argv.insert(1, "assign-sessions")
