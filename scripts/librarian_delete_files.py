...
This script has been superseded by the `librarian delete-files` command.
...
if __name__ == "__main__":
    warnings.warn("This script has been supserseded by the `librarian delete-files` "
    ...
    sys.argv.insert(1, "delete-files")
