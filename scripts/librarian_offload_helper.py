...
This script has been superseded by the `librarian offload-helper` command.
...
if __name__ == "__main__":
    warnings.warn("This script has been supserseded by the `librarian offload-helper` "
    ...
    sys.argv.insert(1, "offload-helper")
