...
"""Script for adding a librarian file event.

This script has been superseded by the `librarian add-file-event` command.
...
if __name__ == "__main__":
    warnings.warn("This script has been supserseded by the `librarian add-file-event` "
    ...
    sys.argv.insert(1, "add-file-event")
