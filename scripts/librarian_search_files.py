...
This script has been superseded by the `librarian search-files` command.
...
if __name__ == "__main__":
    warnings.warn("This script has been supserseded by the `librarian search-files` "
    ...
    sys.argv.insert(1, "search-files")
