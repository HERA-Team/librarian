...
This script has been superseded by the `librarian add-obs` command.
...
if __name__ == "__main__":
    warnings.warn("This script has been supserseded by the `librarian add-obs` "
