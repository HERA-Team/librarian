...
class Server(BaseModel):
    ...
    LIBRARIAN_SERVER_MAXIMAL_UPLOAD_SIZE: int
    ...
    def env(self) -> dict[str, str]:
        return {
            ...
            "LIBRARIAN_SERVER_MAXIMAL_UPLOAD_SIZE": str(
                self.LIBRARIAN_SERVER_MAXIMAL_UPLOAD_SIZE
            ),
...
def server_setup(tmp_path_factory, name="librarian_server") -> Server:
    ...
    return Server(
        ...
        LIBRARIAN_SERVER_MAXIMAL_UPLOAD_SIZE=1_000_000,  # 1 MB for testing
